...
/* HERO */
// Adiciona as props
export function BemVindo({ onLogin, onCadastro }: { onLogin: () => void, onCadastro: () => void }) {
  return (
    <View style={styles.hero}>
      ...
      <View style={styles.buttons}>
        ...
        <TouchableOpacity style={styles.button} onPress={onCadastro}>
  ...
  return (
    <View ref={sectionRef} style={styles.section}>
      ...
      <Text style={styles.sectionText}>
        A <Text style={{ fontWeight: "bold" }}>Invicta Finanças</Text> é um
        projeto acadêmico criado por estudantes universitários com o objetivo de
        desenvolver uma ferramenta intuitiva para controle financeiro pessoal.
      </Text>
      <Text style={styles.sectionText}>
      ...
      <View style={styles.sobreCard}>
        ...
        <Text style={styles.sobreCardText}>
          Facilitando o controle das finanças pessoais de forma prática e
          educativa.
        </Text>
      </View>
    </View>
  ...
  const items = [
    {
      ...
      title: "Investimentos",
      desc: "Monitore e cresça seus investimentos com facilidade.",
    },
    {
      icon: "card-outline" as const,
      title: "Controle de Gastos",
      desc: "Acompanhe suas despesas e mantenha seu orçamento equilibrado.",
    },
    {
      icon: "bar-chart-outline" as const,
      title: "Relatórios",
      desc: "Visualize gráficos e relatórios detalhados de suas finanças.",
    },
  ];
