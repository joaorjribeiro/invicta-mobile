...
export default function TransacoesScreen() {
  ...
  // Listener em tempo real das transações
  useEffect(() => {
    if (!user) return;
  ...
  async function handleSalvar() {
    ...
    const valorNum = Math.round(parseFloat(valorNormalizado) * 100) / 100;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.resumoContainer}>
        ...
        <View style={styles.saldoCard}>
          ...
          <Text style={[styles.saldoValor, { color: saldo >= 0 ? "#22c55e" : "#ef4b2a" }]}>
      ...
      <View style={styles.filtroContainer}>
        {(["Todos", "Entrada", "Saida"] as FiltroTipo[]).map((f) => (
          <TouchableOpacity
            ...
            onPress={() => setFiltro(f)}
          >
            <Text style={[styles.filtroBtnText, filtro === f && styles.filtroBtnTextAtivo]}>
              {f === "Saida" ? "Saídas" : f}
            </Text>
          </TouchableOpacity>
        ))}
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.lista}>
        {transacoesFiltradas.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubText}>Toque em + para registrar agora.</Text>
          </View>
        ) : (
        ...
        >
          <View style={styles.modalContent}>
            ...
            <View style={styles.tipoRow}>
              <TouchableOpacity
                style={[styles.tipoBtn, tipo === "Entrada" && styles.tipoBtnActiveEntrada]}
              ...
              >
                ...
                />
                <Text style={[styles.tipoBtnText, tipo === "Entrada" && { color: "#fff" }]}>
                  Entrada
                </Text>
              </TouchableOpacity>
              ...
              >
                ...
                />
                <Text style={[styles.tipoBtnText, tipo === "Saida" && { color: "#fff" }]}>
                  Saída
                </Text>
              </TouchableOpacity>
            </View>
            ...
            >
              {salvando ? (
                ...
                <>
                  <Ionicons
                    name={tipo === "Entrada" ? "arrow-up-circle" : "arrow-down-circle"}
                    size={20}
                    color="#fff"
                  />
...
const styles = StyleSheet.create({
  ...
  addBtn: { backgroundColor: "rgba(255,255,255,0.22)", borderRadius: 8, padding: 6 },
  resumoContainer: { padding: 16, paddingBottom: 0 },
  resumoRow: { flexDirection: "row", gap: 10, marginBottom: 10 },
  resumoCard: {
    flex: 1, backgroundColor: "#fff", borderRadius: 14,
    padding: 14, elevation: 2, borderWidth: 1, borderColor: "#f0f0f0",
  },
  ...
  resumoLabel: { fontSize: 11, color: "#999", marginBottom: 4, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  saldoCard: {
    ...
    elevation: 2, borderWidth: 1, borderColor: "#f0f0f0", marginBottom: 4,
  },
  ...
  row: {
    ...
    marginBottom: 4, paddingVertical: 12, paddingHorizontal: 12,
    borderRadius: 12, elevation: 1, gap: 10,
  },
  tipoIndicator: { width: 32, height: 32, borderRadius: 8, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  rowCenter: { flex: 1, minWidth: 0 },
  cellDesc: { fontSize: 13, color: "#222", fontWeight: "600" },
  cellData: { fontSize: 11, color: "#999", marginTop: 2 },
  categoriaTag: {
    marginTop: 3, alignSelf: "flex-start", backgroundColor: "#f3f3f3",
  ...
  emptySubText: { color: "#bbb", fontSize: 13, marginTop: 6, textAlign: "center" },
  fab: {
    position: "absolute", bottom: 24, right: 20,
    width: 56, height: 56, borderRadius: 28,
    backgroundColor: "#ef4b2a", alignItems: "center", justifyContent: "center",
    elevation: 6, shadowColor: "#ef4b2a", shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.35, shadowRadius: 8,
  },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.45)", justifyContent: "flex-end" },
  modalContent: { backgroundColor: "#fff", borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 },
  modalAlca: { width: 40, height: 4, backgroundColor: "#e0e0e0", borderRadius: 2, alignSelf: "center", marginBottom: 16 },
  ...
  label: { fontSize: 12, color: "#888", marginBottom: 6, marginTop: 14, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.4 },
  input: { backgroundColor: "#f7f7f7", borderRadius: 10, padding: 13, fontSize: 15, borderWidth: 1, borderColor: "#ebebeb", color: "#111" },
  inputValorWrap: { flexDirection: "row", alignItems: "center", backgroundColor: "#f7f7f7", borderRadius: 10, borderWidth: 1, borderColor: "#ebebeb", paddingLeft: 13 },
  inputPrefix: { fontSize: 15, color: "#888", marginRight: 4 },
  inputValor: { flex: 1, backgroundColor: "transparent", borderWidth: 0, paddingLeft: 0 },
  ...
  salvarBtn: { marginTop: 24, padding: 16, borderRadius: 14, alignItems: "center", flexDirection: "row", justifyContent: "center", gap: 8 },
